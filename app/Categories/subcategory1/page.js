...
export default function SubCategory1 () {
  ...
  const handleDelete = async id => {
    ...
    try {
      const response = await fetch(
        'http://192.168.141.25:3001/snapbazzar/deletesubcategory1',
        {
          method: 'DELETE',
          headers: {
  ...
  const addSubCategory1 = async () => {
    // console.log("update sub ", subcategoryId, selectedCategory?.id);
    // return;
    ...
    try {
      const response = await fetch(
        'http://192.168.141.25:3001/snapbazzar/addSubcategories1',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
  ...
  const handleView = id => {
    alert(`Viewing subcategory with ID: ${id}`)
  }
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await fetch(
        'http://192.168.141.25:3001/snapbazzar/updatesubcategory1',
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
    ...
    <div className='flex min-h-screen bg-gray-100'>
      ...
      <div className='flex-1 p-6 mt-20 ml-0 sm:ml-64'>
        <div className='bg-white p-6 rounded-md shadow-md w-full mb-6'>
          <h3 className='text-xl font-semibold mb-4'>Add SubCategories1</h3>
        ...
        <div className='bg-white p-6 rounded-md shadow-md w-full mb-4'>
          <div className='flex items-center justify-between mb-4'>
            <h3 className='text-xl font-semibold'>Subcategory1 List</h3>
            <input
              type='text'
              value={searchQuery}
